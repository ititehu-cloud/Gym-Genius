      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="space-y-6 py-4">
          <div className="relative">
            <Label htmlFor="message" className="absolute -top-2 left-3 px-1 bg-background text-[10px] text-muted-foreground uppercase font-bold tracking-wider z-10">Preview message....</Label>
            <Textarea
              id="message"
              value={message}
              onChange={(e) => setMessage(e.target.value)}
              className="min-h-[240px] bg-muted/5 pt-4 resize-none border-muted-foreground/20 focus-visible:ring-primary font-mono text-xs"
            />
          </div>
        </div>
